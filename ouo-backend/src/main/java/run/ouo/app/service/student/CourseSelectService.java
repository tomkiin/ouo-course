...
import run.ouo.app.manager.student.CourseSelectManager;
...
import run.ouo.app.model.vo.response.table.StudentCourseSelectItemVO;
...
public class CourseSelectService extends BaseService {
    ...
    public ResultVO getPageCount(String courseName, String teacherName) {
        ...
        return success(manager.getPageCount(studentId, courseName, teacherName));
    }
